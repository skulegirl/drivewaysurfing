      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" bgcolor="#FFFFFF" style="font-family: verdana, arial, helvetica; font-size: small;">
        ...
        <tr valign="top">
          <td>
            ...
            <p><b><?php print t('Thanks for your order!'); ?></b></p>
            <?php endif; ?>
            ...
            <table cellpadding="4" cellspacing="0" border="0" width="100%" style="font-family: verdana, arial, helvetica; font-size: small;">
              ...
              <tr>
                <td colspan="2">
                  ...
                  <?php echo t('If you have any questions regarding your order, please do not hesitate to <a href="!contact_us_url/Inquiry regarding order !order_number">contact us</a>.', array('!contact_us_url' => $store_help_url, '!order_number' => $order->order_id)); ?>
                  <br /></p>
                  <?php endif; ?>
